                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                ...
                                <a href="{{route('view-invoice',['id'=>$orderDetails->id])}}" class="btn btn-primary float-right">
                                    Make Invoice
                                </a>
                            </div>
                            <div class="card-body">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <table class="table table-bordered">
                                    <tr>
                                        <th>Customer name</th>
                                        <td>{{$orderDetails->customer->first_name}}</td>
                                    </tr>
                                    <tr>
                                        <th>Phone No.</th>
                            ...
                            <div class="card-body">
                                <table class="table table-bordered">
                                    ...
                                    <tr>
                                        ...
                                        <td>Tk. {{$productDetail->product_quantity*$productDetail->product_price}}</td>
                                    </tr>
                                    @endforeach
                                </table>
                            </div>
